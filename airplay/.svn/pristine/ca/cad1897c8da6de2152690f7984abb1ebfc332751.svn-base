...
import javax.jmdns.impl.tasks.state.Flush;
import javax.jmdns.impl.tasks.state.FlushAn;
...
public interface DNSTaskStarter {
    ...
    public static final class DNSTaskStarterImpl implements DNSTaskStarter {
        ...
        public void startFlush(){
        	new Flush(_jmDNSImpl).start(_stateTimer);
        }
        
        public void startFlushAn(int ttl){
        	new FlushAn(_jmDNSImpl, ttl).start(_stateTimer);
        }
