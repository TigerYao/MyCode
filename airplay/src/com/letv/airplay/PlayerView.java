...
public class PlayerView extends RelativeLayout {
	...
	public void removePureBG() {
		Log.d(TAG, "handleMessage removePureBG");
	...
	public void setMusicLogo(byte[] logo) {
		this.logo = logo;
		Log.d(TAG, "setMusicLogo handleMessage removePureBG");
		handler.removeMessages(TYPE_PURE_BG);
		handler.sendEmptyMessage(TYPE_MUSIC_WITH_PIC);
	}
	...
	public void setCenterProgressBarShow(boolean isShow) {
		Log.e(TAG, "onInfo " + "setCenterProgressBarShow " + isShow);
	...
	private void init() {
		...
		// +Thread.currentThread().getId());
		View view = View.inflate(context, R.layout.player_view, this);
	...
	private void setCenterProgressBarHandle(boolean isShow) {
		...
		// +Thread.currentThread().getId());
		System.out.println("progress**" + isShow);
	...
	private void setCurrentTimeHandle(int currentTime, String text) {
		if (currentTimeText == null || controlSeekBar == null)
			return;
	...
	private void setProgressBarImageHandle(int type) {
		switch (type) {
		case 0:
			progressImage.setBackgroundResource(R.drawable.play_seekbar_play);
			break;
		case 1:
			progressImage.setBackgroundResource(R.drawable.play_seekbar_pause);
			break;
		case 2:
			progressImage.setBackgroundResource(R.drawable.play_seekbar_right);
			break;
		case 3:
			progressImage.setBackgroundResource(R.drawable.play_seekbar_left);
			break;
		default:
			progressImage.setBackgroundResource(R.drawable.play_seekbar_play);
			break;
