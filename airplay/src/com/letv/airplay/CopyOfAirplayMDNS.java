...
class CopyOfAirplayMDNS {
	public static CopyOfAirplayMDNS _instance;
	...
	public CopyOfAirplayMDNS(AirplayService airplayService) {
	...
	public static CopyOfAirplayMDNS getInstance(AirplayService airplayService) {
		if (_instance == null) {
			_instance = new CopyOfAirplayMDNS(airplayService);
		}
		return _instance;
	}
	...
	private boolean BindInterface() {
		...
		getIp(deviceName, networkinfo);
		return true;

	}

	private void getIp(String deviceName, NetworkInfo networkinfo) {
